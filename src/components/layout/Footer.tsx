...
export function Footer() {
  ...
  return (
    <footer className="mx-auto mt-12 w-[min(1160px,calc(100%-28px))] pb-10 sm:w-[min(1160px,calc(100%-40px))]">
      <Card className="overflow-hidden rounded-none border-stone-300 shadow-[8px_8px_0_rgba(26,26,26,0.88)]">
        <div className="grid gap-0 lg:grid-cols-[minmax(0,0.8fr)_minmax(420px,1fr)]">
          <div className="p-5 sm:p-7">
            ...
            <h2 className="mt-3 text-4xl font-black leading-none text-neutral-950 sm:text-5xl">
              {t("contactUs")}
            </h2>
        ...
        <div className="flex flex-col gap-2 border-t border-stone-200 px-5 py-4 text-sm font-bold text-neutral-500 sm:flex-row sm:items-center sm:justify-between sm:px-7">
          <span>{t("dailyWall")}</span>
