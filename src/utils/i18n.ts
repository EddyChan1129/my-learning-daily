...
export const resources = {
    zh: {
        translation: {
            ...
            create: "建立",
            createAccount: "建立帳戶",
            dailyPrompt: "每日學新野，記低一點，感受自己正在進步。",
            dailyTagline: "You Decide",
            dailyWall: "Day One / One Day",
            dateLearned: "學習日期",
            delete: "刪除",
            description: "個人介紹",
            edit: "編輯",
            ...
            emoji: "表情",
            footer: "每日做同樣的記錄，才會看見真正的改變。",
            faq: "常見問題",
            findTutor: "尋找導師",
            heroBody: "每日學新野，感受自己進步。每日做同樣既野然後想得到改變，先係真正既痴線。",
            home: "首頁",
            language: "語言",
            large: "大字",
            latest: "最新",
    ...
    en: {
        translation: {
            ...
            dailyPrompt: "Learn something each day, write it down, and feel your progress compound.",
            dailyTagline: "You Decide",
            dailyWall: "Day One / One Day",
            ...
            emoji: "Emoji",
            footer: "Small daily records make real change visible.",
            faq: "FAQ",
            findTutor: "Find tutor",
            heroBody: "Learn something new every day, record it, and feel yourself moving forward.",
            home: "Home",
            language: "Language",
            large: "Large",
            latest: "Latest",
