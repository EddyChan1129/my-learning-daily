...
export const resources = {
  zh: {
    translation: {
      ...
      heroBody: "記錄每日讀書、生活觀察、截圖和之後值得重溫的想法。",
      language: "語言",
      large: "大字",
      latest: "最新",
      learningWall: "學習牆",
  ...
  en: {
    translation: {
      ...
      footer: "Study, life, and one small record of progress each day.",
      heroBody: "A daily record of study notes, life observations, screenshots, and ideas worth revisiting.",
      language: "Language",
      large: "Large",
      latest: "Latest",
